...
![Minecraft](https://img.shields.io/badge/Minecraft-26.3-blue)
...
Requires [Fabric Loader](https://fabricmc.net/use/) 0.19.3 or newer and any version from Minecraft 26.2 to 26.3. **Fabric API is not required.**
